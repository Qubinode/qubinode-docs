...
project = 'Qubindode'
copyright = "2021, Qubinode project"
...
html_short_title = 'Qubinode Documentation'
...
html_context = {
    'display_github': 'True',
    'github_user': 'amalivert',
    'github_repo': 'qubinode-docs',
    'github_version': 'master/docs/docsite/rst/',
    #'github_module_version': 'master/lib/ansible/modules/',
    #'github_root_dir': 'master/lib/ansible',
    #'github_cli_version': 'master/lib/ansible/cli/',
    'current_version': version,
    'latest_version': '1.0',
    # list specifically out of order to make latest work
    'available_versions': ('latest', 'master', 'dev'),
...
html_title = 'Qubinode Documentation'
