...
author = u'Oluwatosin Akinosho, Rodrique Heron,' \
         u'Joey Amanchukwu, Abnerson Malivert'
 
copyright = author
# The version info for the project you're documenting, acts as replacement for
# |version| and |release|A, also used in various other places throughout the
# built documents.
#
...
html_logo='images/QubinodeFinal.png'
