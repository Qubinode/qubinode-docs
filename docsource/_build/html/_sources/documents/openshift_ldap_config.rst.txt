...
2. Click on actions then ``Reset Password`` |image0|
3. default clusteradmin password is ``clusteradmin`` |image1|
4. Click on ``ldapidp`` |image2|
5. Login to OpenShift with new Password |image3|
...
`EXAMPLES OF COMMON
LDAPSEARCHES <https://access.redhat.com/documentation/en-us/red_hat_directory_server/10/html/administration_guide/examples-of-common-ldapsearches>`__
...
**Edit the following line numbers** \* 55 \* 61 \* 70
...
.. |image0| image:: https://i.imgur.com/WzBtlHT.png
.. |image1| image:: https://i.imgur.com/M1LlmC8.png
.. |image2| image:: https://i.imgur.com/jM8ZhPQ.png
.. |image3| image:: https://i.imgur.com/46AfUUP.png
